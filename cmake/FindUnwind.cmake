...
if (Unwind_INCLUDE_DIR
  ...
  if(UNWIND_SHARED_LIBRARY_LZMA)
    ...
    set_target_properties(unwind-shared PROPERTIES
      ...
      IMPORTED_LOCATION ${UNWIND_STATIC_LIBRARY_CORE} ${UNWIND_STATIC_LIBRARY_PLATFORM} ${UNWIND_SHARED_LIBRARY_LZMA}
    )
  else()
    set_target_properties(unwind-shared PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${UNWIND_INCLUDE_DIR}"
      IMPORTED_LOCATION ${UNWIND_STATIC_LIBRARY_CORE} ${UNWIND_STATIC_LIBRARY_PLATFORM}
    )
  endif()
  ...
  if(UNWIND_STATIC_LIBRARY_LZMA)
    ...
    set_target_properties(unwind-static PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${UNWIND_INCLUDE_DIR}"
      IMPORTED_LOCATION ${UNWIND_STATIC_LIBRARY_CORE} ${UNWIND_STATIC_LIBRARY_PLATFORM} ${UNWIND_STATIC_LIBRARY_LZMA}
    )
  else()
    set_target_properties(unwind-static PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${UNWIND_INCLUDE_DIR}"
