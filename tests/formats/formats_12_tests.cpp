...
// 1.2 specific tests
INSTANTIATE_TEST_SUITE_P(format_12_test, format_12_test_case, kTestValues,
                         format_12_test_case::to_string);

// Generic tests
INSTANTIATE_TEST_SUITE_P(format_12_test, format_test_case_with_encryption,
                         kTestValues, format_12_test_case::to_string);

INSTANTIATE_TEST_SUITE_P(format_12_test, format_test_case, kTestValues,
                         format_12_test_case::to_string);
