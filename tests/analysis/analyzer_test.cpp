...
TEST_F(analyzer_test, test_load) {
  ...
  {
    auto analyzer = irs::analysis::analyzers::get("text", irs::text_format::json, "{\"locale\":\"en\", \"ignoredWords\":[\"abc\", \"def\", \"ghi\"]}");
  ...
  ASSERT_EQ(nullptr, irs::analysis::analyzers::get("text", irs::text_format::json, "{{\"locale\":\"en\", \"ignoredWords\":\"abc\"}}"));
  ASSERT_EQ(nullptr, irs::analysis::analyzers::get("text", irs::text_format::json, "{{\"locale\":\"en\", \"ignoredWords\":[1, 2, 3]}}"));
}
