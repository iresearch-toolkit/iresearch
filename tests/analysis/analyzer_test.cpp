...
TEST_F(analyzer_test, duplicate_register) {
  ...
  if (initial_expected) {
    ...
    ASSERT_EQ(nullptr,
              irs::analysis::analyzers::get(
                irs::type<dummy_analyzer>::name(),
                irs::type<irs::text_format::json>::get(), irs::string_ref{}));
    ASSERT_EQ(nullptr,
              irs::analysis::analyzers::get(
                irs::type<dummy_analyzer>::name(),
                irs::type<irs::text_format::text>::get(), irs::string_ref{}));
    ASSERT_EQ(nullptr,
              irs::analysis::analyzers::get(
                irs::type<dummy_analyzer>::name(),
                irs::type<irs::text_format::vpack>::get(), irs::string_ref{}));

    irs::analysis::analyzer_registrar initial0(
      irs::type<dummy_analyzer>::get(),
      irs::type<irs::text_format::vpack>::get(), &dummy_analyzer::make,
      &dummy_analyzer::normalize);
    irs::analysis::analyzer_registrar initial1(
      irs::type<dummy_analyzer>::get(),
      irs::type<irs::text_format::json>::get(), &dummy_analyzer::make,
      &dummy_analyzer::normalize);
    irs::analysis::analyzer_registrar initial2(
      irs::type<dummy_analyzer>::get(),
  ...
  initial_expected = false;  // next test iteration will not be able to register
                             // the same analyzer
  irs::analysis::analyzer_registrar duplicate0(
    irs::type<dummy_analyzer>::get(), irs::type<irs::text_format::vpack>::get(),
    &dummy_analyzer::make, &dummy_analyzer::normalize);
  irs::analysis::analyzer_registrar duplicate1(
    irs::type<dummy_analyzer>::get(), irs::type<irs::text_format::json>::get(),
    &dummy_analyzer::make, &dummy_analyzer::normalize);
  irs::analysis::analyzer_registrar duplicate2(
    irs::type<dummy_analyzer>::get(), irs::type<irs::text_format::text>::get(),
    &dummy_analyzer::make, &dummy_analyzer::normalize);
  ...
  ASSERT_TRUE(irs::analysis::analyzers::exists(
    ...
    irs::type<irs::text_format::vpack>::get()));
  ASSERT_TRUE(
    irs::analysis::analyzers::exists(irs::type<dummy_analyzer>::name(),
                                     irs::type<irs::text_format::json>::get()));
  ASSERT_TRUE(
    irs::analysis::analyzers::exists(irs::type<dummy_analyzer>::name(),
                                     irs::type<irs::text_format::text>::get()));
