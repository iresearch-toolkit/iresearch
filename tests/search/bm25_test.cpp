...
TEST_P(bm25_test, test_phrase) {
  ...
  // "jumps high" with order
  {
    ...
    filter.field("phrase_anl")
          .push_back(irs::by_phrase::info_t::simple_term{}, "jumps")
          .push_back(irs::by_phrase::info_t::simple_term{}, "high");
...
//  }
  ...
  // by phrase
  {
    ...
    filter.field("field").push_back(irs::by_phrase::info_t::simple_term{}, "7");
