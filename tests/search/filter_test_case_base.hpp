...
struct custom_sort: public irs::sort {
    ...
    class scorer: public irs::sort::scorer_base<irs::doc_id_t> {
     public:
      ...
      scorer(
        ...
        const irs::attribute_store& document_attrs
     ...
     private:
      const irs::attribute_store& document_attrs_;
  ...
  std::function<void(const irs::attribute_store&)> collector_term;
  std::function<collector::ptr()> prepare_collector;
  std::function<scorer::ptr(const irs::sub_reader&, const irs::term_reader&, const irs::attribute_store&, const irs::attribute_store&)> prepare_scorer;
