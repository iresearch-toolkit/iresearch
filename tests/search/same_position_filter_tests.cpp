  ...
  void sub_objects_ordered() {
    ...
    // collector count (single term)
    {
      ...
      filter.mutable_options()->terms.emplace_back(
        "phrase", irs::ref_cast<irs::byte_type>(std::string_view("quick")));
    ...
    // collector count (multiple terms)
    {
      ...
      filter.mutable_options()->terms.emplace_back(
        "phrase", irs::ref_cast<irs::byte_type>(std::string_view("quick")));
      filter.mutable_options()->terms.emplace_back(
        "phrase", irs::ref_cast<irs::byte_type>(std::string_view("brown")));
  ...
  void sub_objects_unordered() {
    ...
    // { a: 100 } - equal to 'by_term'
    {
      ...
      query.mutable_options()->terms.emplace_back(
        "a", irs::ref_cast<irs::byte_type>(std::string_view("100")));

      irs::by_term expected_query;
      *expected_query.mutable_field() = "a";
      expected_query.mutable_options()->term =
        irs::ref_cast<irs::byte_type>(std::string_view("100"));
    ...
    // { a: 300, b:90, c:9 }
    {
      ...
      q.mutable_options()->terms.emplace_back(
        "a", irs::ref_cast<irs::byte_type>(std::string_view("300")));
      q.mutable_options()->terms.emplace_back(
        "b", irs::ref_cast<irs::byte_type>(std::string_view("90")));
      q.mutable_options()->terms.emplace_back(
        "c", irs::ref_cast<irs::byte_type>(std::string_view("9")));
      auto prepared = q.prepare(index);
      auto docs = prepared->execute(segment);
      auto* doc = irs::get<irs::document>(*docs);
      ASSERT_EQ(docs->value(), doc->value);
    ...
    // { a: 100, b:30, c:6 }
    {
      ...
      q.mutable_options()->terms.emplace_back(
        "a", irs::ref_cast<irs::byte_type>(std::string_view("100")));
      q.mutable_options()->terms.emplace_back(
        "b", irs::ref_cast<irs::byte_type>(std::string_view("30")));
      q.mutable_options()->terms.emplace_back(
        "c", irs::ref_cast<irs::byte_type>(std::string_view("6")));
    ...
    // { c: 8, b:80, a:700 }
    {
      irs::by_same_position q;
      q.mutable_options()->terms.emplace_back(
        "c", irs::ref_cast<irs::byte_type>(std::string_view("8")));
      q.mutable_options()->terms.emplace_back(
        "b", irs::ref_cast<irs::byte_type>(std::string_view("80")));
      q.mutable_options()->terms.emplace_back(
        "a", irs::ref_cast<irs::byte_type>(std::string_view("700")));
    ...
    // { a: 700, b:*, c: 7 }
    {
      ...
      q.mutable_options()->terms.emplace_back(
        "a", irs::ref_cast<irs::byte_type>(std::string_view("700")));
      q.mutable_options()->terms.emplace_back(
        "c", irs::ref_cast<irs::byte_type>(std::string_view("7")));
...
// single term
{
  irs::by_same_position q;
  q.mutable_options()->terms.emplace_back(
    "field", irs::ref_cast<irs::byte_type>(std::string_view("quick")));
...
// multiple terms
{
  ...
  q.mutable_options()->terms.emplace_back(
    "field", irs::ref_cast<irs::byte_type>(std::string_view("quick")));
  q.mutable_options()->terms.emplace_back(
    "field", irs::ref_cast<irs::byte_type>(std::string_view("brown")));
...
TEST(by_same_position_test, equal) {
...

  {
    ...
    q0.mutable_options()->terms.emplace_back(
      "speed", irs::ref_cast<irs::byte_type>(std::string_view("quick")));
    q0.mutable_options()->terms.emplace_back(
      "color", irs::ref_cast<irs::byte_type>(std::string_view("brown")));
...

  {
    ...
    q0.mutable_options()->terms.emplace_back(
      "color", irs::ref_cast<irs::byte_type>(std::string_view("brown")));
    q0.mutable_options()->terms.emplace_back(
      "name", irs::ref_cast<irs::byte_type>(std::string_view("fox")));
    ...
    q1.mutable_options()->terms.emplace_back(
      "color", irs::ref_cast<irs::byte_type>(std::string_view("brown")));
    q1.mutable_options()->terms.emplace_back(
      "name", irs::ref_cast<irs::byte_type>(std::string_view("squirrel")));
    ASSERT_NE(q0, q1);
  }
