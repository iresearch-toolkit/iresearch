...
TEST_P(tfidf_test, test_phrase) {
  ...
  // "jumps high" with order
  {
    ...
    *filter.mutable_field() = "phrase_anl";
    ...
    phrase.push_back(irs::simple_term{}).term = irs::ref_cast<irs::byte_type>(irs::string_ref("jumps"));
    phrase.push_back(irs::simple_term{}).term = irs::ref_cast<irs::byte_type>(irs::string_ref("high"));
...
//  }
  ...
  // by_phrase
  {
    ...
    *filter.mutable_field() = "field";
    auto& phrase = *filter.mutable_options();
    phrase.push_back<irs::simple_term>().term = irs::ref_cast<irs::byte_type>(irs::string_ref("7"));
