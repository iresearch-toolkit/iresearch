...
//////////////////////////////////////////////////////////////////////////////
/// @class string_ref_input
//////////////////////////////////////////////////////////////////////////////
class IRESEARCH_API string_ref_input : public index_input {
  public:
    string_ref_input() = default;
    explicit string_ref_input(const string_ref& data);
    ...
    virtual const byte_type* read_buffer(size_t offset, size_t size, BufferHint /*hint*/) noexcept override final {
      ...
      if (end <= data_.end()) {
        pos_ = end;
        return reinterpret_cast<const byte_type *>(begin);
      }
    ...
    virtual const byte_type* read_buffer(size_t size, BufferHint /*hint*/) noexcept override final {
      ...
      if (pos <= data_.end()) {
        std::swap(pos, pos_);
        return reinterpret_cast<const byte_type *>(pos);
      }
    ...
    void reset(const byte_type* data, size_t size) noexcept {
      data_ = string_ref(reinterpret_cast<const char*>(data), size);
      pos_ = reinterpret_cast<const char *>(data);
    }
    ...
    virtual ptr dup() const override {
      return memory::make_unique<string_ref_input>(*this);
    }
