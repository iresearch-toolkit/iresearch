...
// MSVC < v14.0 (Visual Studio >2015) does not support explicit initializer for
// arrays: error C2536 GCC < v4.9 does not initialize the union array member
// with the specified value (initializes with {0,0}) CLANG (at least 4.0.1) does
// not support constexpr reinterpret cast for versions @see
// https://github.com/thp/psmoveapi/blob/master/external/glm/glm/simd/platform.h
#if defined(__APPLE__) || (defined(__clang__) && (__clang_major__ > 4)) || \
...
struct numeric_traits<int32_t> {
  ...
  static bytes_ref min() { return mini32(); }
  static bytes_ref max() { return maxi32(); }
...
struct numeric_traits<uint32_t> {
  ...
  inline static integral_t integral(integral_t value) { return value; }
  static bytes_ref min() { return minu32(); }
  static bytes_ref max() { return maxu32(); }
  static bytes_ref raw_ref(integral_t const& value) {
    return bytes_ref(reinterpret_cast<irs::byte_type const*>(&value),
                     sizeof(value));
  }
  constexpr static size_t size() { return sizeof(integral_t) + 1; }
};
...
struct numeric_traits<int64_t> {
  ...
  static bytes_ref min() { return mini64(); }
  static bytes_ref max() { return maxi64(); }
  inline static integral_t integral(integral_t value) { return value; }
  constexpr static size_t size() { return sizeof(integral_t) + 1; }
  static size_t encode(integral_t value, byte_type* out, size_t offset = 0) {
...
struct numeric_traits<uint64_t> {
  ...
  inline static integral_t integral(integral_t value) { return value; }
  static bytes_ref max() { return maxu64(); }
  static bytes_ref min() { return minu64(); }
  static bytes_ref raw_ref(integral_t const& value) {
    return bytes_ref(reinterpret_cast<irs::byte_type const*>(&value),
                     sizeof(value));
  }
...
struct numeric_traits<float> {
  typedef int32_t integral_t;
  static bytes_ref ninf() { return nfinf32(); }
  static bytes_ref min() { return minf32(); }
  static bytes_ref max() { return maxf32(); }
  static bytes_ref inf() { return finf32(); }
...
struct numeric_traits<double> {
  typedef int64_t integral_t;
  static bytes_ref ninf() { return ndinf64(); }
  static bytes_ref min() { return mind64(); }
  static bytes_ref max() { return maxd64(); }
  static bytes_ref inf() { return dinf64(); }
